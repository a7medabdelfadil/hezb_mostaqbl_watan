...
const translations = {
  ar: {
    statsTitle: "إحصائيات نواب الحزب في مجلس الشيوخ",
    statsDesc:
      "نظرة رقمية على تمثيل الحزب في مجلس الشيوخ، موزعة حسب المحافظات واللجان البرلمانية ونوع العضوية",
    mp: "نائب مجلس الشيوخ",
    governorate: "محافظة",
    committee: "لجنة برلمانية",
    title: "نواب الحزب في مجلس الشيوخ",
    subTitle:
      "ممثلو الحزب في مجلس الشيوخ ودورهم في التشريع والعمل الرقابي.",
  ...
  en: {
    statsTitle: "Party Senators Statistics",
    statsDesc:
      "A numeric overview of the party's representation in the Senate by governorates, committees, and membership type.",
    mp: "Senate MPs",
    governorate: "Governorates",
    committee: "Committees",
    title: "Party Senators in the Senate",
    subTitle: "Party representatives in the Senate, contributing to legislation and oversight.",
    search: "Search senator...",
    btn: "Show more",
    filters: {
...
export default function SenateSection() {
  ...
  return (
    <section
      dir={lang === "ar" ? "rtl" : "ltr"}
      className="w-full bg-white px-4 py-12 text-center md:px-24"
    >
      <div className="w-full mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          <div className="flex flex-col gap-1">
            <p className="text-3xl font-bold text-primary3">80</p>
          ...
          <div className="flex flex-col gap-1">
            <p className="text-3xl font-bold text-primary3">15</p>
